...
tokenizer = RobertaTokenizer.from_pretrained('roberta-large-mnli', cache_dir = "/work/yinghork")
...
def main():
    ...
    #prepare data
    dataset = load_dataset("json", data_files={'train': os.path.join(args.dataset_path, 'siq_fold_' + str(args.fold) + '.jsonl')}, cache_dir="/work/yinghork")
